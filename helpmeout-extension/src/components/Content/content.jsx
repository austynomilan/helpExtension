...
export default function content() {
  return (
    <div className='text-center relative mt-4'>
      ...
      <div class='flex justify-center items-center mt-5'>
        <div class='w-64 border-2 border-primary-300 rounded-lg h-12 flex justify-between items-center'>
          <div class='flex ml-2'>
            ...
            <p class="font-def text-primary-600 font-medium">Camera</p>
          </div>
          <label for='toggleB' class='flex items-center cursor-pointer'>
            <div class='relative '>
              <input type='checkbox' id='toggleB' class='sr-only' />
              <div class='block mr-2 bg-primary-600 w-11 h-6 rounded-full'></div>
      ...
      <div class='flex justify-center items-center mt-5 '>
        <div class='w-64 border-2 border-primary-600  rounded-lg h-12 flex justify-between items-center'>
          <div class='flex ml-2'>
            <svg
              xmlns='http://www.w3.org/2000/svg'
              fill='none'
            ...
            <p class="font-def text-primary-600 font-medium">Audio</p>
          </div>
      ...
      <button class='bg-primary-600 mt-6 text-white w-64 h-12 rounded-lg'>
        Start Recording
      </button>
    </div>
  );
